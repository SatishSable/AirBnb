/**
 * WanderLust AI Chatbot Controller
...
async function getGeminiResponse(userMessage, conversationHistory) {
  ...
  try {
    const systemPrompt = `You are WanderBot, the friendly and helpful AI assistant for WanderLust — a premium travel platform similar to Airbnb. You help users with:
...
const knowledgeBase = {
  greetings: {
    ...
    responses: [
      "Hello! 👋 Welcome to WanderLust! I'm WanderBot, your personal travel assistant. How can I help you today? Whether you're looking for stays, vehicles, or dining — I've got you covered! ✨",
      "Hey there! 🌟 I'm WanderBot, here to make your travel planning seamless. Need help finding the perfect stay, renting a vehicle, or discovering local dining? Just ask!",
      "Hi! Welcome aboard! 🏠 I'm your WanderLust assistant. I can help you explore stays, vehicles, and dining options. What are you looking for today?"
    ]
  },
  farewell: {
  ...
  thanks: {
    ...
    responses: [
      "You're welcome! 😊 Happy to help! Is there anything else you'd like to know about WanderLust?",
